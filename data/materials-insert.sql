-- Comprehensive Materials Database INSERT Statements
-- Generated: 2026-04-25
-- Platform: HCHC (Hill Country Home Concepts)
-- Total: 100 materials across 6 categories
--
...
('Daltile Emerson Wood Porcelain Tile', 'flooring', 'cool', 'mid', 'Daltile', 'Emerson Wood', 'Ash White', 'EM01-0648', '6x48 porcelain wood-look tile in cool ash-white for contemporary interiors'),
...
('Fabuwood Allure Galaxy', 'cabinetry', 'neutral', 'mid', 'Fabuwood', 'Allure Galaxy', 'Frost', 'FAB-GALAXY-FRST', 'Best-selling all-wood shaker door in bright frost white painted finish'),
('Fabuwood Allure Galaxy', 'cabinetry', 'cool', 'mid', 'Fabuwood', 'Allure Galaxy', 'Dove', 'FAB-GALAXY-DOVE', 'Soft gray-toned shaker cabinet in dove finish for cool transitional kitchens'),
('Fabuwood Allure Fusion', 'cabinetry', 'warm', 'mid', 'Fabuwood', 'Allure Fusion', 'Mocha', 'FAB-FUSION-MCH', 'Slab-style contemporary door in warm mocha stain for modern kitchens'),
...
('IKEA AXSTAD', 'cabinetry', 'neutral', 'low', 'IKEA', 'AXSTAD', 'Matte White', '704.682.84', 'Modern matte white shaker-style door with clean Scandinavian lines'),
('IKEA BODBYN', 'cabinetry', 'cool', 'low', 'IKEA', 'BODBYN', 'Gray', '302.210.53', 'Traditional frame-and-panel door in soft gray with beveled edge detail'),
...
('Cabinets To Go Tuscany', 'cabinetry', 'warm', 'low', 'Cabinets To Go', 'Tuscany', 'Saddle', 'CTG-TUSCANY-SDL', 'Raised-panel door in warm saddle brown stain with Old World character'),
('KraftMaid ColorCast Cottage', 'cabinetry', 'warm', 'high', 'KraftMaid', 'ColorCast', 'Shortbread', 'KM-COLORCAST-SB', 'New 2025 painted finish in warm shortbread cream with subtle depth');

-- ============================================================
-- COUNTERTOPS (15 items)
-- ============================================================
...
('Cambria Kenwood', 'countertops', 'warm', 'high', 'Cambria', 'Natural Collection', 'Kenwood', 'CAM-KENWOOD', 'New 2025 warm ivory background with delicate taupe veining and crackle detail'),
('Cambria Clovelly', 'countertops', 'warm', 'high', 'Cambria', 'Natural Collection', 'Clovelly', 'CAM-CLOVELLY', 'Warm welcoming quartz with soft movement and creamy undertones for transitional kitchens'),
...
('Bedrosians Cloe Ceramic Subway', 'backsplash', 'neutral', 'mid', 'Bedrosians', 'Cloe', 'White', 'DECCLOSWHT28G', 'Handmade-look 2.5x8 glossy ceramic subway with beautiful color variation'),
('Bedrosians Cloe Ceramic Subway', 'backsplash', 'warm', 'mid', 'Bedrosians', 'Cloe', 'Creme', 'DECCLOCRM28G', 'Warm creme glossy ceramic subway tile with artisan variation for inviting kitchens'),
('Bedrosians Cloe Ceramic Subway', 'backsplash', 'cool', 'mid', 'Bedrosians', 'Cloe', 'Baby Blue', 'DECCLOBLU28G', 'Soft baby blue handmade-look subway for coastal and Hill Country inspired spaces'),
...
('Clé Tile Zellige', 'backsplash', 'warm', 'high', 'Clé Tile', 'Zellige', 'Weathered White', 'CLE-ZLG-WTHWHT', 'Handmade Moroccan zellige tile with natural variation and warm patina'),
('Clé Tile Zellige', 'backsplash', 'cool', 'high', 'Clé Tile', 'Zellige', 'Moroccan Blue', 'CLE-ZLG-MRCBLU', 'Artisanal hand-cut zellige in deep Moroccan blue for statement backsplashes'),
('Daltile Color Wheel Mosaic', 'backsplash', 'cool', 'low', 'Daltile', 'Color Wheel Retro', 'Ice White', 'CW02-22PM1P', 'Classic 2x2 ceramic mosaic in ice white for clean, modern kitchen backsplashes');
...
('Top Knobs Charlotte Bar Pull', 'hardware', 'warm', 'mid', 'Top Knobs', 'Dakota', 'Honey Bronze', 'M2111', 'Elegant 6-inch bar pull in honey bronze with tapered ends'),
('Top Knobs Charlotte Bar Pull', 'hardware', 'cool', 'mid', 'Top Knobs', 'Dakota', 'Brushed Satin Nickel', 'M1281', 'Classic 3-inch bar pull in brushed satin nickel for transitional kitchens'),
...
('Franklin Brass Vignette Dual Mount Pull', 'hardware', 'warm', 'low', 'Franklin Brass', 'Vignette', 'Venetian Bronze', 'P17890V-VBR-C', 'Budget-friendly 3-inch dual mount pull in warm venetian bronze'),
...
INSERT INTO materials (name, category, tone, price_tier, vendor, series, color, sku, description) VALUES
('Sherwin-Williams Alabaster', 'paint', 'warm', 'mid', 'Sherwin-Williams', 'Top 50', 'Alabaster', 'SW 7008', 'Best-selling warm off-white with faint yellow undertone, works on walls, trim, and exterior'),
('Sherwin-Williams Agreeable Gray', 'paint', 'warm', 'mid', 'Sherwin-Williams', 'Top 50', 'Agreeable Gray', 'SW 7029', 'Warm greige that is the most popular SW color, perfect for open floor plans'),
...
('Sherwin-Williams Clary Sage', 'paint', 'warm', 'mid', 'Sherwin-Williams', 'Green Family', 'Clary Sage', 'SW 6178', 'Soft earthy sage green that pairs beautifully with warm neutrals and natural wood'),
...
('Sherwin-Williams Anonymous', 'paint', 'cool', 'mid', 'Sherwin-Williams', 'Neutral Family', 'Anonymous', 'SW 7046', 'Sophisticated dark greige with cool undertones for accent walls and statements'),
('Sherwin-Williams Halcyon Green', 'paint', 'cool', 'mid', 'Sherwin-Williams', 'Green Family', 'Halcyon Green', 'SW 6213', 'Gentle sage with LRV around 54, especially popular for kitchens'),
...
('Benjamin Moore Hale Navy', 'paint', 'cool', 'high', 'Benjamin Moore', 'Historical Collection', 'Hale Navy', 'HC-154', 'Rich deep navy for dramatic accent walls, pairs beautifully with warm whites'),
...
-- ============================================================
-- INDEXES (recommended for query performance)
-- ============================================================
